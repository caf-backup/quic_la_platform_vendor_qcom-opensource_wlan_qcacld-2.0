...
CDEFINES +=	-DQCA_TXRX_PERF \
		...
		-DHIF_RX_THREAD
ifneq ($(CONFIG_LATENCY_OPTIMIZE), y)
CDEFINES +=	-DCONFIG_PERF_NON_QC_PLATFORM
endif
endif

ifeq ($(CONFIG_LATENCY_OPTIMIZE), y)
CDEFINES +=	-DLATENCY_OPTIMIZE
endif
...
ifeq ($(CONFIG_TSF_SHOW_QTIME), y)
CDEFINES += -DWLAN_FEATURE_TSF_SHOW_QTIME
endif

ifeq ($(CONFIG_TSF_IRQ_AMEND), y)
ifeq ($(CONFIG_TSF_SHOW_QTIME), y)
CDEFINES += -DWLAN_FEATURE_TSF_IRQ_AMEND
ifeq ($(CONFIG_TSF_IRQ_AMEND_DEBUG), y)
CDEFINES += -DWLAN_FEATURE_TSF_IRQ_AMEND_DEBUG
endif
endif
endif
...
# Disable fallthrough warning as error
