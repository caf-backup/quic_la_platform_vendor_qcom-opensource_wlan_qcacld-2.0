...
/*  
    ...
    * 0x0 - Disable eapol sanity checking in the RX path 
...
#define CFG_COEX_CONFIG_COEX_ENABLE_MCC_TDM         "gEnableCoexMCCTDM"
#define CFG_COEX_CONFIG_COEX_ENABLE_MCC_TDM_MIN      (0)
#define CFG_COEX_CONFIG_COEX_ENABLE_MCC_TDM_MAX      (1)
#define CFG_COEX_CONFIG_COEX_ENABLE_MCC_TDM_DEFAULT  (0)
...
/* VOS Trace Control*/
   ...
   uint32_t                    coex_config_coex_enable_mcc_tdm;
