...
#define CFG_WOW_PULSE_SUPPORT_DEFAULT  (1)
...
#define CFG_WOW_PULSE_INTERVAL_LOW_DEFAULT  (20)
...
#define CFG_WOW_PULSE_INTERVAL_HIGH_DEFAULT (180)
...
#define CFG_WOW_PULSE_REPEAT_COUNT_DEFAULT (1)
