...
/* CFG_VOS_TRACE_ENABLE Parameters */
   ...
   REG_VARIABLE(CFG_SHUTUP_HI_SYSTEM_SLEEP_NAME, WLAN_PARAM_Integer,
		hdd_config_t, shut_up_hi_system_sleep,
		VAR_FLAGS_OPTIONAL | VAR_FLAGS_RANGE_CHECK_ASSUME_DEFAULT,
		CFG_SHUTUP_HI_SYSTEM_SLEEP_DEFAULT,
		CFG_SHUTUP_HI_SYSTEM_SLEEP_DISABLE,
		CFG_SHUTUP_HI_SYSTEM_SLEEP_ENABLE),
