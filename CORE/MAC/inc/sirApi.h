...
/* Max number of channels are 177, but to access 165th element of array,
 *array of 178 is required.
 */
#define SIR_MAX_24G_5G_CHANNEL_RANGE      (177 + 1)
...
struct sir_au_get_txrx_stat_resp {
	uint32_t vdev_id;
	uint32_t num_groups;
	struct sir_au_group_stat au_group_stat[MAX_GROUP_NUM];
	uint32_t num_peers;
