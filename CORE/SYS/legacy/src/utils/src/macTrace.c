...
tANI_U8* macTraceGetSmeMsgString(tANI_U16 smeMsg)
{
	...
	CASE_RETURN_STRING(eWNI_SME_AU_TXRX_STAT_IND);
#endif
	default:
		return((tANI_U8*)"UNKNOWN");
		break;
...
#ifdef AUDIO_MULTICAST_AGGR_SUPPORT
	CASE_RETURN_STRING(WDA_SET_MULTICAST_RATE);
	CASE_RETURN_STRING(WDA_SET_MULTICAST_AUTO_RATE);
	CASE_RETURN_STRING(WDA_SET_MULTICAST_STA);
#endif
	default:
		return((tANI_U8*) "UNKNOWN");
		break;
